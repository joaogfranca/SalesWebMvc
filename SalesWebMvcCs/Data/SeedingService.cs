...
using System.Linq;
using SalesWebMvcCs.Models.Enums;

namespace SalesWebMvcCs.Data
{
    public class SeedingService
    {
        private SalesWebMvcCsContext _context;

        public SeedingService(SalesWebMvcCsContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Andre", "andre@gmail.com", new DateTime(2000, 4, 8), 1600.0, d1);
